...
\title{[C] Can a computer detect human sarcasm?}
...
\begin{abstract} %%% DO NOT CHANGE!
	...
	\noindent{Social} behavior in humans are a complex subject that can seem almost impossible to fully understand. A good example of this are usage of sarcasm in interactions, which is famously easily to create misunderstandings, especially when written, because of intonation and voice features are often used to clear markers for a sarcastic comment. Therefore this project aims to explore how well different machine learning models can classify sarcasm from orinary sentences. The models that will be examined are Logistic regression with TF-IDF features, LSTM and BERT. The data that will be used to training, validation and testing will be sarcastic comments taken from two social media platforms. After training and validation, the models preformance was compared and the result was ---. (Some more discussion will be added here too)
...
\fbox{\parbox[t][][t]{\columnwidth}{
		...
		Provide the reader of the general context of the research question that you chose to investigate, providing the relevant peer-reviewed references.  For example, a citation looks like \cite{SharmaEtAl2026} or \cite{Archana2025, EkeEtAl202021, JamilEtAl2021, KumarEtAl2020}.
...
\begin{table*}
	...
	\begin{tabular}{| l | l | l | l |}
		...
		\hspace{0.1cm}
		\parbox{5.5cm}{\begin{flushleft}
				               Can capture word order which is important for sarcasm. Can connect words over larger distances in sentences. Also solves the vanishing gradient problem.
			               \end{flushleft}}
		\hspace{0.1cm}
		               &
		\hspace{0.1cm}
		\parbox{5.5cm}{\begin{flushleft}
				               Medium size model that works great for text classification.
			               \end{flushleft}}
		\hspace{0.1cm}
		\\
		\hline
		...
		\hspace{0.1cm}
		\parbox{5.5cm}{\begin{flushleft}
				               Large model that already a good understanding about our language, which makes it perfect for using in this setting.
...
{\bf Method 1 (substitute with the name of the method).} {[Discuss the use case scenarios of the method, their features with advantages and disadvantages / strong and weak points, and whether it is more or less suitable for the research question. It is a good idea to reference the literature \cite{ EkeEtAl202021}.]}

{\bf Method 2 (substitute with the name of the method).} {[Discuss the use case scenarios of the method, their features with advantages and disadvantages / strong and weak points, and whether it is more or less suitable for the research question. It is a good idea to reference the literature \cite{EkeEtAl202021}.]}

{\bf Method 3 (substitute with the name of the method).} {[Discuss the use case scenarios of the method, their features with advantages and disadvantages / strong and weak points, and whether it is more or less suitable for the research question. It is a good idea to reference the literature \cite{EkeEtAl202021}.]}
